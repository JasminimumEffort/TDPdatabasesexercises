...
#14
SELECT f.film_id, i.inventory_id, r.rental_date, f.rental_duration, r.return_date, f.title, DATE_ADD(r.rental_date, INTERVAL f.rental_duration DAY) AS duedate
FROM inventory i
JOIN rental r on r.inventory_id=i.inventory_id
JOIN film f on f.film_id = i.film_id
